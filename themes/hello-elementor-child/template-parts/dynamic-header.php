    ...
    <?php if ($header_mobile_nav_menu) : ?>
      ...
      <button class="nav-menu" type="button" aria-label="menu">
        <svg id="bars" width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <line y1="0.649988" x2="18" y2="0.649988" stroke="currentColor" stroke-width="1.3" />
          <line y1="5.64999" x2="18" y2="5.64999" stroke="currentColor" stroke-width="1.3" />
          <line y1="10.65" x2="18" y2="10.65" stroke="currentColor" stroke-width="1.3" />
        </svg>
        <svg id="x" width="18" height="18" class="hide" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">>
...
<div class="side-nav">
  <div class="side-nav-top">
    <button type="button" class="side-nav-exit">
      <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">>
        <path fill="#FEEDE6" d="M504.6 148.5C515.9 134.9 514.1 114.7 500.5 103.4C486.9 92.1 466.7 93.9 455.4 107.5L320 270L184.6 107.5C173.3 93.9 153.1 92.1 139.5 103.4C125.9 114.7 124.1 134.9 135.4 148.5L278.3 320L135.4 491.5C124.1 505.1 125.9 525.3 139.5 536.6C153.1 547.9 173.3 546.1 184.6 532.5L320 370L455.4 532.5C466.7 546.1 486.9 547.9 500.5 536.6C514.1 525.3 515.9 505.1 504.6 491.5L361.7 320L504.6 148.5z" />
      </svg>
    </button>
  </div>
  ...
  <div class="side-nav-links">
    <a href="/properties/?category=for-sale" class="link link--major">Services</a>
    <a href="/properties/?category=for-sale" class="link">Buy</a>
    <a href="/properties/?category=for-rent" class="link">Rent</a>
    <a href="/sell" class="link">Sell</a>
    <a href="/city" class="link link--major">Cities</a>
    <div class="side-nav-cities"></div>
    <a href="/about" class="link link--major">Who We Are</a>
    <a href="/testimonials" class="link">Testimonials</a>
    <a href="/about" class="link">About</a>
    <a href="/contact-us" class="link link--major">Contact Us</a>
  </div>
</div>

<script>
  document.addEventListener('DOMContentLoaded', function() {
    if (typeof window.renderNavCities === 'function') {
      window.renderNavCities(<?php echo wp_json_encode($cities, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>);
    }
  });
</script>